        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-slate-light via-white to-beige-light">
            <CardContent className="p-8 md:p-12 relative">
              <img src="/lovable-uploads/280b909b-ceb8-422b-9f23-2e56e36a673e.png" alt="Unity Advisory Logo" className="absolute top-4 right-4 md:top-6 md:right-6 h-5 md:h-8 w-auto" />
