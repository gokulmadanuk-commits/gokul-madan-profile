...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 px-4 md:px-6 lg:px-[150px]">
      <div className="bg-gradient-to-br from-emerald-700 via-green-600 to-emerald-500 text-white rounded-xl overflow-hidden shadow-xl">
        <div className="flex flex-col lg:flex-row">
          {/* Left side with image */}
          <div className="lg:w-1/3 relative h-[400px] lg:h-full">
            <img 
              src="/lovable-uploads/7c829219-3347-4cd9-9f73-d092d5fd1e4c.png" 
              alt="Gokul Madan" 
              className="absolute bottom-0 left-1/2 transform -translate-x-1/2 h-auto max-h-[160%] w-auto"
