      ...
      <div className="section-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-green">Ex-PwC. Driving Deals Automation and helping PE PortCos unlock value.</p>
            <Button className="mt-6 group" size="lg" variant="green">
              <Download className="mr-2 h-4 w-4 group-hover:animate-bounce" />
              Download My Resume
            </Button>
          </div>
          <div className="relative rounded-2xl overflow-hidden shadow-2xl animate-fade-in border border-green/10">
            <div className="aspect-video bg-gray-200 w-full">
              ...
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-green">Video Introduction</p>
                </div>
              </div>
            </div>
          </div>
